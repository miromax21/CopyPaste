...
/*
 @author: Alexander @joker_in_the_pack
 @link: https://habr.com/ru/post/658083/
 */
...
extension CustomSpinnerSimple {
  func view(visible: Bool) {
    UIView.animate(withDuration: 1, delay: 0, options: .curveEaseOut) { [unowned self] in
      alpha = visible ? 1 : 0
